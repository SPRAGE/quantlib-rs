...
impl AnalyticCompoundOptionEngine {
    ...
    pub fn calculate(&self, args: &CompoundOptionArgs) -> CompoundOptionResult {
        ...
        // Gamma
        let gamma = (dd_d / (vol_d * spot))
            * (inv_m_time * n_xm * nt12 + w * inv_d_time * nd_plus * ne_x);

        // Vega
        let vega = dd_d
            * spot
            * (t_m.sqrt() * n_xm * nt12 + w * t_d.sqrt() * nd_plus * ne_x);
...
mod tests {
    ...
    fn test_compound_option_values() {
        ...
        let values = [
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Call,
                strike_mother: 50.0, strike_daughter: 520.0,
                s: 500.0, q: 0.03, r: 0.08, t_mother: 0.25, t_daughter: 0.5, v: 0.35,
                npv: 21.1965, tol: 1.0e-3, delta: -0.1966, gamma: 0.0007,
                vega: -32.1241, theta: -3.3837,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Call,
                strike_mother: 50.0, strike_daughter: 520.0,
                s: 500.0, q: 0.03, r: 0.08, t_mother: 0.25, t_daughter: 0.5, v: 0.35,
                npv: 17.5945, tol: 1.0e-3, delta: 0.3219, gamma: 0.0038,
                vega: 106.5185, theta: -65.1614,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Put,
                strike_mother: 50.0, strike_daughter: 520.0,
                s: 500.0, q: 0.03, r: 0.08, t_mother: 0.25, t_daughter: 0.5, v: 0.35,
                npv: 18.7128, tol: 1.0e-3, delta: -0.2906, gamma: 0.0036,
                vega: 103.3856, theta: -46.6982,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Put,
                strike_mother: 50.0, strike_daughter: 520.0,
                s: 500.0, q: 0.03, r: 0.08, t_mother: 0.25, t_daughter: 0.5, v: 0.35,
                npv: 15.2601, tol: 1.0e-3, delta: 0.1760, gamma: 0.0005,
                vega: -35.2570, theta: -10.1126,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Call,
                strike_mother: 0.05, strike_daughter: 1.14,
                s: 1.20, q: 0.0, r: 0.01, t_mother: 0.5, t_daughter: 2.0, v: 0.11,
                npv: 0.0729, tol: 1.0e-3, delta: 0.6614, gamma: 2.5762,
                vega: 0.5812, theta: -0.0297,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Put,
                strike_mother: 0.05, strike_daughter: 1.14,
                s: 1.20, q: 0.0, r: 0.01, t_mother: 0.5, t_daughter: 2.0, v: 0.11,
                npv: 0.0074, tol: 1.0e-3, delta: -0.1334, gamma: 1.9681,
                vega: 0.2933, theta: -0.0155,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Call,
                strike_mother: 0.05, strike_daughter: 1.14,
                s: 1.20, q: 0.0, r: 0.01, t_mother: 0.5, t_daughter: 2.0, v: 0.11,
                npv: 0.0021, tol: 1.0e-3, delta: -0.0426, gamma: 0.7252,
                vega: -0.0052, theta: -0.0058,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Put,
                strike_mother: 0.05, strike_daughter: 1.14,
                s: 1.20, q: 0.0, r: 0.01, t_mother: 0.5, t_daughter: 2.0, v: 0.11,
                npv: 0.0192, tol: 1.0e-3, delta: 0.1626, gamma: 0.1171,
                vega: -0.2931, theta: -0.0028,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Call,
                strike_mother: 10.0, strike_daughter: 122.0,
                s: 120.0, q: 0.06, r: 0.02, t_mother: 0.1, t_daughter: 0.7, v: 0.22,
                npv: 0.4419, tol: 1.0e-3, delta: 0.1049, gamma: 0.0195,
                vega: 11.3368, theta: -6.2871,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Put,
                strike_mother: 10.0, strike_daughter: 122.0,
                s: 120.0, q: 0.06, r: 0.02, t_mother: 0.1, t_daughter: 0.7, v: 0.22,
                npv: 2.6112, tol: 1.0e-3, delta: -0.3618, gamma: 0.0337,
                vega: 28.4843, theta: -13.4124,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Call,
                strike_mother: 10.0, strike_daughter: 122.0,
                s: 120.0, q: 0.06, r: 0.02, t_mother: 0.1, t_daughter: 0.7, v: 0.22,
                npv: 4.1616, tol: 1.0e-3, delta: -0.3174, gamma: 0.0024,
                vega: -26.6403, theta: -2.2720,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Put,
                strike_mother: 10.0, strike_daughter: 122.0,
                s: 120.0, q: 0.06, r: 0.02, t_mother: 0.1, t_daughter: 0.7, v: 0.22,
                npv: 1.0914, tol: 1.0e-3, delta: 0.1748, gamma: 0.0165,
                vega: -9.4928, theta: -4.8995,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Call,
                strike_mother: 0.4, strike_daughter: 8.2,
                s: 8.0, q: 0.05, r: 0.00, t_mother: 2.0, t_daughter: 3.0, v: 0.08,
                npv: 0.0099, tol: 1.0e-3, delta: 0.0285, gamma: 0.0688,
                vega: 0.7764, theta: -0.0027,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Put,
                strike_mother: 0.4, strike_daughter: 8.2,
                s: 8.0, q: 0.05, r: 0.00, t_mother: 2.0, t_daughter: 3.0, v: 0.08,
                npv: 0.9826, tol: 1.0e-3, delta: -0.7224, gamma: 0.2158,
                vega: 2.7279, theta: -0.3332,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Call,
                strike_mother: 0.4, strike_daughter: 8.2,
                s: 8.0, q: 0.05, r: 0.00, t_mother: 2.0, t_daughter: 3.0, v: 0.08,
                npv: 0.3585, tol: 1.0e-3, delta: -0.0720, gamma: -0.0835,
                vega: -1.5633, theta: -0.0117,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Put,
                strike_mother: 0.4, strike_daughter: 8.2,
                s: 8.0, q: 0.05, r: 0.00, t_mother: 2.0, t_daughter: 3.0, v: 0.08,
                npv: 0.0168, tol: 1.0e-3, delta: 0.0378, gamma: 0.0635,
                vega: 0.3882, theta: 0.0021,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Call,
                strike_mother: 0.02, strike_daughter: 1.6,
                s: 1.6, q: 0.013, r: 0.022, t_mother: 0.45, t_daughter: 0.5, v: 0.17,
                npv: 0.0680, tol: 1.0e-3, delta: 0.4937, gamma: 2.1271,
                vega: 0.4418, theta: -0.0843,
            },
            CompoundOptionData {
                type_mother: OptionType::Call, type_daughter: OptionType::Put,
                strike_mother: 0.02, strike_daughter: 1.6,
                s: 1.6, q: 0.013, r: 0.022, t_mother: 0.45, t_daughter: 0.5, v: 0.17,
                npv: 0.0605, tol: 1.0e-3, delta: -0.4169, gamma: 2.0836,
                vega: 0.4330, theta: -0.0697,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Call,
                strike_mother: 0.02, strike_daughter: 1.6,
                s: 1.6, q: 0.013, r: 0.022, t_mother: 0.45, t_daughter: 0.5, v: 0.17,
                npv: 0.0081, tol: 1.0e-3, delta: -0.0417, gamma: 0.0761,
                vega: -0.0045, theta: -0.0020,
            },
            CompoundOptionData {
                type_mother: OptionType::Put, type_daughter: OptionType::Put,
                strike_mother: 0.02, strike_daughter: 1.6,
                s: 1.6, q: 0.013, r: 0.022, t_mother: 0.45, t_daughter: 0.5, v: 0.17,
                npv: 0.0078, tol: 1.0e-3, delta: 0.0413, gamma: 0.0326,
                vega: -0.0133, theta: -0.0016,
            },
        ];
